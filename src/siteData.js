const siteData = {
    ...
    projects: [
    ...
    
        {
            ...
            "description": "<h4>What is it?</h4><p>RSnip is an online tool that allows users to create and share small snippets of code built in React. Common web solutions shouldn't be hard to code. You've already done it once, why do it again? With RSnip, you can save your React code as a snippet to view and use later.</p><h4>The Technical Side</h4><p>RSnip was built in a team of four for a projects class at Neumont College of Computer Science. The frontend was built in React and is served up through AWS Amplify. The backend of the website is built with AWS services. We use Amplify to host the site,Lambda's and a Rest API to serve data, and DynamoDB as the database.</p><h4>What I Learned</h4><p>This was the first time that any of the four of us had worked with AWS.This was a big learning curve, but we were able to utilize it how we needed in the time limit we had. I also learned how to render React code on the browser in an isolated container. I needed to make sure that any code written by users did not affect any other parts of the website.</p>",
        ...
        },
        {
            ...
            "description": "<h4>What is it?</h4><p>A portfolio website for Janell Rogers, an Actor, Director, and Stage Manager. As Janell finished up college, she was in need of a lively and interactive way of sharing her work with the world. This portfolio features her works, resume, and ways to get in contact.</p><h4>The Technical Side</h4><p>This portfolio was built in React, with Framer Motion for animations. As I was developing this site, I wanted to find an easy way for Janell to modify content on her own. This inspired my next project \"React Simple CMS\", which is a React library that offers an easy way for Janell to keep her portfolio fresh.</p><h4>What I Learned</h4><p>When developing this portfolio, I wanted to make sure the elements were lively to reflect the creative field Janell is in. I learned how to use Framer Motion to create text, page-transition, and on-scroll animations.</p>",
    ...
    
        {
            ...
            "description": "<h4>What is it?</h4><p>Bello is a lightweight clone of Trello, a project management board tool. Bello helps keep track of project tasks and how far along they are in the project. Bello is account based and supports multiple boards per user. Users can create lists within the boards and can drag their tasks from one list to the next.</p><p>Bello was originally created by other students. My teammate and I used this as an opportunity to learn how to work in existing code.</p><h4>The Technical Side</h4><p>Originally this website only had a front-end and was built on a simple Node Express server with Pug. My teammate and I took this chance to recreate the front-end in React while also setting up a back-end and Mongo database. We then added more features such as accounts, multiple boards per user, data persistence, and full board customization.</p><h4>What I Learned</h4><p>From working on this project, I learned how to work in existing code. Learning how to read and understand someone else's code was not easy, but it helped me understand the different ways of looking at a problem. I also learned how to break up tasks into sizable chunks and create accurate time estimates.</p>",
